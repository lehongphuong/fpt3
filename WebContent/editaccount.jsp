                        ...
                        <div class="card contact-card card-cascade narrower mb-r">
                            <div class="admin-panel info-admin-panel">
                                ...
                                <div class="card-block text-center">
                                    <img src="https://mdbootstrap.com/img/Photos/Avatars/avatar-5.jpg" alt="User Photo" class="rounded-circle contact-avatar my-2 mx-auto" />
                                ...
                                <div class="card-block">
                                    ...
                                    <html:form action="/edit-account.do">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="md-form">
                                                    <html:text property="password" styleId="form81" styleClass="form-control validate"/>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="md-form">
                                                <html:text property="point" styleId="form76" styleClass="form-control validate" />
